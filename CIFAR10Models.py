...
class Encoder(nn.Module):
    ...
    def __init__(self, latent_size=256, nc=3, width=1):
        ...
        self.conv6 = nn.Conv2d(32*self.width, out_channels=32*self.width, kernel_size=3, stride=1, padding=1)
...
class YotoEncoder(nn.Module):
    ...
    def __init__(self, latent_size=256, nc=3, width=1):
        ...
        self.film3 = FiLMBlock(32*self.width)
...
def CIFAR10Encoder(width=1):
    return Encoder(256, 3, width)

def CIFAR10YotoEncoder(width=1):
...
class Decoder(nn.Module):
    ...
    def __init__(self, latent_size=256, nc=3, width=1):
        ...
        self.conv1U = nn.ConvTranspose2d(32*self.width, out_channels=32*self.width, kernel_size=3, stride=2, padding=1, output_padding=1)
        self.conv2U = nn.ConvTranspose2d(32*self.width, out_channels=16*self.width, kernel_size=3, stride=1, padding=1, output_padding=0)
        self.conv3U = nn.ConvTranspose2d(16*self.width, out_channels=16*self.width, kernel_size=3, stride=2, padding=1, output_padding=1)
        self.conv4U = nn.ConvTranspose2d(16*self.width, out_channels=8*self.width, kernel_size=3, stride=1, padding=1, output_padding=0)
        self.conv5U = nn.ConvTranspose2d(8*self.width, out_channels=8*self.width, kernel_size=3, stride=2, padding=1, output_padding=1)
        self.conv6U = nn.ConvTranspose2d(8*self.width, out_channels=3*self.width, kernel_size=3, stride=1, padding=1, output_padding=0)
...
class YotoDecoder(nn.Module):
    ...
    def __init__(self, latent_size=256, nc=3, width=1):
        ...
        self.film3U = FiLMBlock(3*self.width)
...
def CIFAR10Decoder(width=1):
    return Decoder(256, 3, width)

def CIFAR10YotoDecoder(width=1):
